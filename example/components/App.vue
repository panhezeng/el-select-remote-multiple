<template>
  <div id="app">
    <h1>因为apiary的mock比较弱，如想获得预期效果，纯搜索只支持输入 Option name 1 ，创建功能只支持输入 Option name 2</h1>
...
//    components: {ElSelectRemoteMultiple},
    data () {
      return {
        apiUrlOptions: 'https://private-87040-publicexample.apiary-mock.com/el-select-remote-multiple/options',
        apiUrlCreate: 'https://private-87040-publicexample.apiary-mock.com/el-select-remote-multiple/option',
        selected: [],
        selectedObj: []
      }
    }
